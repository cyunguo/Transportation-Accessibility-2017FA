...
[people job zone] = model_set_up_1(num_ppl, num_job, zone_size, city_scale, CBD_region_size, mode, trans_improve);
...
[people job zone] = model_set_up_2(num_ppl, num_job, zone_size, city_scale, CBD_region_size, mode, trans_improve);
% [people job zone] = model_set_up(1000,800,10,2,3);
